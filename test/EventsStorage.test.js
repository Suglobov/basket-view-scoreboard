...
describe('errors', () => {
    test('input param', () => {
        ...
        expect(warn).toBeCalledWith(new Error('[object Object] is instanceof Object, not Array'));

        eventStorage.on({}, () => { });
        expect(warn).toBeCalledWith(new Error('[object Object] is instanceof Object, not String'));

        eventStorage.off([], () => { });
        expect(warn).toBeCalledWith(new Error(' is instanceof Array, not String'));

        eventStorage.trigger(1, () => { });
        expect(warn).toBeCalledWith(new Error('1 is instanceof Number, not String'));
    ...
    test('wrong handler', () => {
        ...
        expect(warn).toBeCalledWith(new Error('zzz is instanceof String, not Function'));

        eventStorage.off('event1', 'yyy');
        expect(warn).toBeCalledWith(new Error('yyy is instanceof String, not Function'));
